...
# Function to clean markdown table formatting from text
...
# Your original RealtimeSearchEngine function with added cleaning step before returning
def RealtimeSearchEngine(prompt):
    ...
    return AnswerModifier(Answer=cleaned_answer)
